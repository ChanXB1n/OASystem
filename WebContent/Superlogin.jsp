...
<div class="login">
	<h1>超级管理员</h1>
    <form action="SuperLoginServlet" method="post">
    	<input type="text" name="username" placeholder="账号" required="required" />
        <input type="password" name="password" placeholder="密码" required="required" />
        <button type="submit" class="btn btn-primary btn-block btn-large">登录</button>
        <br>
        <button  class="btn btn-primary btn-block btn-large" onclick="javascript:window.location.href='homepage.jsp'">返回</button>
