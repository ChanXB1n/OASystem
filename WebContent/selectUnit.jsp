                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <%
										...
										try {
											...
											String getUnit=request.getParameter("unit");
											String newUnit=new String(getUnit.getBytes("ISO-8859-1"),"UTF-8");
											//System.out.println(newUnit);
											rs=state.executeQuery("select *from notyinfo where unit='"+newUnit+"'");
											int count=0;
											while(rs.next()){
